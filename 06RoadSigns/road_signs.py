...
Train_Path = "D:\\Code\\Sentiment\\GTSRB\\Final_Training\\Images\\*"
Test_Path = "D:\\Code\\Sentiment\\GTSRB\\Final_Test\\Images\\*"
...
if __name__ == '__main__':
    ...
    # 批数据读取
    data_loaders = {
        d: DataLoader(image_datasets[d], batch_size=8, shuffle=True, num_workers=6, pin_memory=True)
        for d in DATASETS
    }
